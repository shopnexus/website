	...
	return (
		<aside className="sticky top-24 overflow-hidden rounded-3xl border border-outline-variant bg-surface shadow-sm">
			<div className="relative aspect-[4/3] bg-gradient-to-br from-primary/10 via-surface-container-low to-secondary-container/50">
				...
				<span className="absolute left-3 top-3 rounded-full bg-surface/90 px-3 py-1 text-label-xs text-on-surface shadow-sm backdrop-blur">Xem trước thẻ sản phẩm</span>
			</div>
			...
			<div className="flex flex-wrap gap-2 text-label-xs text-on-surface-variant">
