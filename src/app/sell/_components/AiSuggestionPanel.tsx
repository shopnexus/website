	...
	return (
		<div className="overflow-hidden rounded-2xl border border-secondary/25 bg-secondary-container/25">
			...
			<div className="space-y-3 p-5">
				<textarea value={note} onChange={(event) => setNote(event.target.value)} placeholder="Ví dụ: Máy dùng 8 tháng, còn hộp, xước nhẹ cạnh trái, muốn bán 6 triệu…" className="min-h-24 w-full resize-y rounded-xl border border-outline-variant bg-surface px-3 py-2.5 text-sm text-on-surface outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/10" />
