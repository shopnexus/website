...
export default function TicketQueueRow({ entry, now }: { entry: AdminTicket; now: number }) {
	...
	return (
		<Link
			...
			className="group flex gap-4 bg-surface-container-lowest border border-outline-variant rounded-2xl p-3 hover:border-primary hover:shadow-sm transition-all"
		>
